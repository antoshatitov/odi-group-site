...
description: Create responsive, mobile-first UI layouts that adapt across screen sizes using flexible grids, relative units, media queries, and touch-friendly design patterns.
---
...
This Skill provides agent with specific guidance on how to adhere to coding standards as they relate to how it should handle frontend responsive.
